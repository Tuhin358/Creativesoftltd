...
class FooterSettingController extends Controller
{
    ...
    {
        $footersettings=FooterSetting::latest()->get();
        return view('adminpanel.footersetting.index',compact('footersettings'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('footer_setting_index');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->back()->with('message','PageSetting Delete Successfully');
    }
}
