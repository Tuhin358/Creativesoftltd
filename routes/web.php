...
Route::group(['prefix' => 'admin','middleware' => ['auth', 'role:admin']], function() {
    ...
    // Route::get('/footer-setting',[FooterSettingController::class,'create'])->name('footer_setting_create');
    // Route::post('/footer-setting/add',[FooterSettingController::class,'store'])->name('footer_setting_add');
    ...
    // Route::get('/footer-setting/delete/{id}',[FooterSettingController::class,'destroy'])->name('footer_setting_delete');
